...
<template>
  <div class="flex flex-col h-full max-h-[90vh] bg-surface">
    ...
    <header class="flex items-center justify-between px-6 py-4 bg-primary-600 text-white shadow-elevation-2">
      ...
      <button
        class="p-2 rounded-m3-md hover:bg-white/10 transition-colors"
        @click="cancel"
        title="Close"
      >
    ...
    <div v-if="error" class="mx-6 mt-4 text-sm text-error-700 bg-error-50 border border-error-200 rounded-m3-md px-4 py-3 flex items-start gap-3 shadow-elevation-1">
    ...
    <div class="flex-1 overflow-y-auto p-6 space-y-6">
      <!-- Basic Info Section -->
      <section class="bg-white rounded-m3-md p-5 shadow-elevation-1 border border-surface-variant space-y-4">
        ...
        <div>
          ...
          <div class="flex items-center gap-3">
            <div class="p-3 bg-surface-2 rounded-m3-md border border-surface-variant">
            ...
            <div class="flex flex-wrap gap-2">
              <button
                ...
                :key="icon"
                class="text-2xl p-2 rounded-m3-md transition-all hover:shadow-elevation-1"
        ...
        <div>
          ...
          <input
            ...
            type="text"
            class="w-full px-4 py-3 text-sm border-2 rounded-m3-md bg-white focus:outline-none focus:shadow-elevation-1 transition-all"
        ...
        <div>
          ...
          <textarea
            ...
            rows="3"
            class="w-full px-4 py-3 text-sm border-2 rounded-m3-md bg-white focus:outline-none focus:shadow-elevation-1 transition-all resize-none"
        ...
        <div>
          ...
          <select
            ...
            class="w-full px-4 py-3 text-sm border-2 border-surface-variant rounded-m3-md bg-white focus:outline-none focus:border-primary-600 focus:shadow-elevation-1 transition-all cursor-pointer"
          >
      ...
      <section class="bg-white rounded-m3-md p-5 shadow-elevation-1 space-y-4"
      ...
      <section class="bg-white rounded-m3-md p-5 shadow-elevation-1 space-y-4"
        ...
        <textarea
          ...
          rows="10"
          class="w-full px-4 py-3 text-sm border-2 rounded-m3-md bg-surface-1/50 focus:outline-none focus:shadow-elevation-1 focus:bg-white transition-all font-mono resize-none"
      ...
      <section class="bg-white rounded-m3-md p-5 shadow-elevation-1 border border-surface-variant space-y-4">
        <div class="flex items-center justify-between pb-2 border-b border-surface-variant">
          ...
          <button
            class="flex items-center gap-1 px-3 py-1.5 text-sm font-medium text-primary-700 bg-primary-50 hover:bg-primary-100 rounded-m3-md transition-colors"
            @click="addTool"
            type="button"
          >
        ...
        <div v-if="formData.tools.length === 0" class="text-sm text-secondary-500 bg-surface-1 border-2 border-dashed border-surface-variant rounded-m3-md px-4 py-6 text-center">
        ...
        <div v-else class="space-y-3">
          <div
            ...
            :key="index"
            class="flex items-center gap-3 p-4 bg-surface-1 border-2 border-surface-variant rounded-m3-md hover:border-primary-300 transition-all"
          >
            <select
              v-model="tool.toolId"
              class="flex-1 px-3 py-2 text-sm border-2 border-surface-variant rounded-m3-md bg-white focus:outline-none focus:border-primary-600 transition-all cursor-pointer"
            >
            ...
            <label class="flex items-center gap-2 text-sm text-secondary-700 cursor-pointer">
              <input
                ...
                type="checkbox"
                class="w-4 h-4 rounded-m3-md border-2 border-surface-variant text-primary-600 focus:ring-2 focus:ring-primary-500 cursor-pointer"
              />
              <span>Required</span>
            </label>
            
            <button
              class="p-2 text-error-600 hover:bg-error-50 rounded-m3-md transition-colors"
      ...
      <section class="bg-white rounded-m3-md p-5 shadow-elevation-1 border border-surface-variant space-y-4">
        ...
        <div>
          <div class="flex items-center justify-between mb-2">
            ...
            <span class="text-sm font-mono text-primary-700 bg-primary-50 px-3 py-1 rounded-m3-md">{{ formData.temperature }}</span>
          </div>
          <input
            ...
            max="2"
            step="0.1"
            class="w-full h-2 bg-surface-2 rounded-m3-md appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-5 [&::-webkit-slider-thumb]:h-5 [&::-webkit-slider-thumb]:rounded-m3-md-full [&::-webkit-slider-thumb]:bg-primary-600 [&::-webkit-slider-thumb]:shadow-elevation-1 hover:[&::-webkit-slider-thumb]:shadow-elevation-2"
          />
          <p class="text-xs text-secondary-500 mt-2">
        ...
        <div>
          ...
          <input
            ...
            max="128000"
            step="256"
            class="w-full px-4 py-3 text-sm border-2 border-surface-variant rounded-m3-md bg-white focus:outline-none focus:border-primary-600 focus:shadow-elevation-1 transition-all"
          />
          <p class="text-xs text-secondary-500 mt-2">
        ...
        <div class="p-4 bg-surface-1 rounded-m3-md border border-surface-variant">
          <label class="flex items-center gap-3 cursor-pointer">
            <input
              v-model="formData.enableLogprobs"
              type="checkbox"
              class="w-5 h-5 rounded-m3-md border-2 border-surface-variant text-primary-600 focus:ring-2 focus:ring-primary-500 cursor-pointer"
            />
            <div>
    ...
    <footer class="flex items-center justify-between px-6 py-4 border-t-2 border-surface-variant bg-white shadow-elevation-2">
      ...
      <div class="flex items-center gap-3">
        <button
          class="px-5 py-2.5 text-sm font-medium text-secondary-700 hover:bg-surface-2 rounded-m3-md transition-all"
          :disabled="isSaving"
          @click="cancel"
          type="button"
        >
        ...
        <button
          class="flex items-center gap-2 px-6 py-2.5 text-sm font-semibold bg-primary-600 text-white rounded-m3-md hover:bg-primary-700 active:bg-primary-800 transition-all shadow-elevation-2 hover:shadow-elevation-3 disabled:opacity-50 disabled:cursor-not-allowed"
          :disabled="isSaving"
          @click="saveAgent"
          type="button"
        >
