        ...
        if self._llm is None:
            ...
            if azure_endpoint:
                ...
                self._llm = AzureChatOpenAI(
                    ...
                    deployment_name=self.model_config.get("model", "gpt-4"),
...
Generate all necessary files including implementation and tests.""")
        ...
        artifacts = self._parse_artifacts(response.content, target_language)
    ...
    def _build_generation_context(self, stack: dict, domain: dict, language: str, framework: str | None, style_guide: str | None) -> str:
